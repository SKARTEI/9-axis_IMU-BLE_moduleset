...
double dt = 0.000;
int temp;
unsigned char a_x_l,a_x_h,a_y_l,a_y_h,a_z_l,a_z_h;
unsigned char g_x_l,g_x_h,g_y_l,g_y_h,g_z_l,g_z_h;
unsigned char m_x_l,m_x_h,m_y_l,m_y_h,m_z_l,m_z_h;
double bas_a_x,bas_a_y,bas_a_z;
double bas_g_x,bas_g_y,bas_g_z;
double a_x,a_y,a_z;
double g_x,g_y,g_z;
double m_x,m_y,m_z;
double mx,my,mz;
...
double las_angle_gx,las_angle_gy,las_angle_gz;
double yaw_g,yaw_m;
